...
* **`Notebooks/`**: Notebooks de Jupyter/Colab con la validación computacional.
    ...
    * [VALIDACION_EXAESCALA_EM_PI](https://github.com/NachoPeinador/Arquitectura-de-Hibridacion-Algoritmica-en-Z-6Z/blob/main/Notebooks/VALIDACION_EXAESCALA_EM_PI.ipynb): Reproduce los experimentos clave citados en el manuscrito.
