...
El software se distribuye bajo un modelo de \textbf{doble licencia} para equilibrar la contribución al bien común con la sostenibilidad de la investigación independiente:
\begin{enumerate}
    \item \textbf{Uso Académico y Open Source}: El código está disponible bajo la licencia \textbf{GNU AGPLv3}, garantizando que cualquier modificación derivada permanezca abierta para la comunidad.
    \item \textbf{Uso Comercial}: Para integración en productos propietarios o entornos corporativos cerrados que requieran exención de las cláusulas de \textit{copyleft}, se dispone de una licencia comercial.
\end{enumerate}
